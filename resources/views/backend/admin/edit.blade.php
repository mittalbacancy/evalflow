...
<div>
     ...
     <!-- Content Header (Page header) -->
        <section class="content-header">
            <ol class="breadcrumb">
                <li>
                 @if (auth()->user()->roles->first()->name == 'ROLE_ADMIN')<a href="{{ url('admin/admin')}}">
                 @else
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12 offset-sm-2">
                    ...
                    <br /> 
                    @endif
                    <form method="post" action="{{ route('admin.update', $user->id) }}"  enctype="multipart/form-data" name="form">
                        @method('PATCH') 
                        @csrf
