    ...
    <div class="col-sm-12">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                @endif
                <i class="fa fa-user"></i>Admin Management</a></li>
            ...
            <div class="col-xs-12">
                <div class="box" style="border:1px solid #d2d6de;">
                    <div class="box-header" style="background-color:#f5f5f5;border-bottom:1px solid #d2d6de;">
                        ...
                        <a class="btn btn-info" href="{{ route('admin.create') }}" title="Add Admin">
                            <i class="fa fa-plus" style="vertical-align:middle"></i> Add Admin
                        </a>
                                    ...
                                    <td class="actions">
                                            ...
                                            <ul class="list-inline" style="margin-bottom:0px;">
                                              @if (auth()->user()->roles->first()->name == 'ROLE_ADMIN')
                                                ...
                                                <li>
                                                <a href="{{ URL::to('admin/admin/' . $user->id . '/edit')  }}"
                                             ...
                                             @if ($user->hasRole('ROLE_ADMIN') == 1 && $user->id != auth()->user()->id)
                                                <li>
